...
Manual downloads for **v0.1.2**:

| Platform | Downloads |
| --- | --- |
| macOS, Apple Silicon | [DMG](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-0.1.2-aarch64-apple-darwin.dmg) · [app ZIP](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-0.1.2-aarch64-apple-darwin.app.zip) · [CLI](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-cli-0.1.2-aarch64-apple-darwin.tar.xz) |
| macOS, Intel | [DMG](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-0.1.2-x86_64-apple-darwin.dmg) · [app ZIP](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-0.1.2-x86_64-apple-darwin.app.zip) · [CLI](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-cli-0.1.2-x86_64-apple-darwin.tar.xz) |
| Windows, x86-64 | [MSI](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-0.1.2-x86_64.msi) · [portable app + CLI](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-0.1.2-x86_64-windows-portable.zip) · [app EXE](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-app-0.1.2-x86_64.exe) · [CLI EXE](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-cli-0.1.2-x86_64.exe) |
| Linux, x86-64 | [AppImage](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-app_0.1.2_x86_64.AppImage) · [DEB](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-app_0.1.2_amd64.deb) · [RPM](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-0.1.2-1.x86_64.rpm) · [Pacman](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-app_0.1.2_x86_64.tar.gz) · [CLI](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.2/clipboard-transformer-cli-0.1.2-x86_64-linux.tar.xz) |
