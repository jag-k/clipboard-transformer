...
Direct links below target **v0.1.6**.
...
| --- | --- | --- |
| Apple Silicon | [DMG](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-0.1.6-aarch64-apple-darwin.dmg) · [app ZIP](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-0.1.6-aarch64-apple-darwin.app.zip) | [CLI archive](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-cli-0.1.6-aarch64-apple-darwin.tar.xz) |
| Intel | [DMG](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-0.1.6-x86_64-apple-darwin.dmg) · [app ZIP](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-0.1.6-x86_64-apple-darwin.app.zip) | [CLI archive](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-cli-0.1.6-x86_64-apple-darwin.tar.xz) |
...
| --- | --- | --- |
| MSI installer | Desktop app + CLI | [MSI](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-0.1.6-x86_64.msi) |
| Portable ZIP | Desktop app + CLI | [ZIP](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-0.1.6-x86_64-windows-portable.zip) |
| Portable GUI | Desktop app only | [EXE](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-app-0.1.6-x86_64.exe) |
| Portable CLI | CLI only | [EXE](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-cli-0.1.6-x86_64.exe) |
...
| Format | Contents | Download |
| --- | --- | --- |
| AppImage | Desktop app only | [AppImage](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-app_0.1.6_x86_64.AppImage) |
| Debian package | Desktop app + CLI | [DEB](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-app_0.1.6_amd64.deb) |
| RPM package | Desktop app + CLI | [RPM](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-0.1.6-1.x86_64.rpm) |
| Pacman package | Desktop app + CLI | [archive](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-app_0.1.6_x86_64.tar.gz) |
| CLI archive | CLI only | [archive](https://github.com/jag-k/clipboard-transformer/releases/download/v0.1.6/clipboard-transformer-cli-0.1.6-x86_64-linux.tar.xz) |
